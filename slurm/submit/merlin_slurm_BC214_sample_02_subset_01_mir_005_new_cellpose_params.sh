...
#SBATCH -o /n/home06/lsepulvedaduran/Software/merfish-parameters/slurm/out/BC214_sample_02_subset_01_mir_005_new_cellpose_params.out
#SBATCH -e /n/home06/lsepulvedaduran/Software/merfish-parameters/slurm/err/BC214_sample_02_subset_01_mir_005_new_cellpose_params.err
...
module load fftw
which python
echo BC214_sample_02_subset_01_mir_005_new_cellpose_params

merlin -k parameters_BC214.json \
       -a merlin_analysis_BC214_tumor_opt_5_mir_005_new_cellpose_params.json \
       -o data_organization_BC214.csv \
       -p positions_BC214_sample_02_subset_01.txt \
       -c C2v6_codebook_mplx.csv \
       -m MERFISH3.json \
       -n 1000 \
       -e /n/holylfs04/LABS/zhuang_lab/Lab/shared/BC214_sample_02_subset_01_merlin  \
       -s /n/holyscratch01/zhuang_lab/Lab/shared \

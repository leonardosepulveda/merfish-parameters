...
#SBATCH -o /n/home06/lsepulvedaduran/Software/merfish-parameters/slurm/out/BC162_BC134_sample_01_multi_params.out
#SBATCH -e /n/home06/lsepulvedaduran/Software/merfish-parameters/slurm/err/BC162_BC134_sample_01_multi_params.err
...
module load fftw
which python
echo BC162_BC134_sample_01_multi_params

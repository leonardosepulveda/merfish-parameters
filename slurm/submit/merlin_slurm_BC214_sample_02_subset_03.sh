...
#SBATCH -o /n/home06/lsepulvedaduran/Software/merfish-parameters/slurm/out/BC214_sample_02_subset_03.out
#SBATCH -e /n/home06/lsepulvedaduran/Software/merfish-parameters/slurm/err/BC214_sample_02_subset_03.err
...
module load fftw
which python
echo BC214_sample_02_subset_03

merlin -k parameters_BC214.json \
       -a merlin_analysis_BC214_subsets.json \
       -o data_organization_BC214.csv \
       -p positions_BC214_sample_02_subset_03.txt \
       -c C2v6_codebook_mplx.csv \
       -m MERFISH3.json \
       -n 1000 \
       -e /n/holyscratch01/zhuang_lab/Lab/shared  \
       -s /n/holyscratch01/zhuang_lab/Lab/shared/BC214_sample_02_subset_03_merlin \
       BC214_sample_02_subset_03_data

data_folder   = 'BC214_sample_02_subset_03_data'
output_folder = 'BC214_sample_02_subset_03_merlin'

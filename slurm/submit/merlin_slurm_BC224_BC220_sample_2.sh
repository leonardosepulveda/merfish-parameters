...
#SBATCH -o /n/home06/lsepulvedaduran/Software/merfish-parameters/slurm/out/BC224_BC220_sample_2.out
#SBATCH -e /n/home06/lsepulvedaduran/Software/merfish-parameters/slurm/err/BC224_BC220_sample_2.err
...
module load fftw
which python
echo BC220_BC220_sample_02_data
